component extends="icfwalktests.BaseSpec" output="false" {
	...
	public void function testSharedVectorsProduceIdenticalCanonicalText() {
		...
		for (var v in vectors) {
			...
			assertExactTextEquals(v.expected, actual, "Vector '" & v.name & "'.");
			assertExactTextEquals(v.sha256, variables.c.canonicalJson.sha256(actual), "Vector '" & v.name & "' checksum.");
		}
	}
	...
	public void function testNullValuedKeysAreRetainedFromJson() {
		...
		assertExactTextEquals('{"a":null,"b":1}', variables.c.canonicalJson.serialize(parsed));
	}
	...
	public void function testExplicitNullAssignmentSerializesAsNull() {
		...
		s["x"] = javaCast("null", "");
		s["y"] = "text";
		assertExactTextEquals('{"x":null,"y":"text"}', variables.c.canonicalJson.serialize(s));
	}
	...
	public void function testBracketKeysPreserveCase() {
		...
		s["itemKey"] = "k";
		s["displayOrder"] = 10;
		assertExactTextEquals('{"displayOrder":10,"itemKey":"k"}', variables.c.canonicalJson.serialize(s));
	}

	public void function testDateFormatting() {
		var d = variables.c.canonicalJson.parseInstant("2026-09-17T00:00:00Z");
		assertExactTextEquals("2026-09-17T00:00:00.000Z", variables.c.canonicalJson.formatDate(d));
		assertExactTextEquals("2026-09-17T13:45:30.123Z", variables.c.canonicalJson.formatDate(variables.c.canonicalJson.parseInstant("2026-09-17T13:45:30.123Z")));
	...
	public void function testDecimalsFromDatabaseStyleValuesFormatPlainly() {
		...
		assertExactTextEquals('{"half":2.5,"score":1}', variables.c.canonicalJson.serialize(s));
	}
}
